...
def draw_reverse_board(next, hold, score, level, goal):
    ...
    screen.blit(text_level, (int(ui_variables.SCREEN_WIDTH * 0.045) + sidebar_width, int(ui_variables.SCREEN_HEIGHT * 0.6791)))
    screen.blit(level_value, (int(ui_variables.SCREEN_WIDTH * 0.055) + sidebar_width, int(ui_variables.SCREEN_HEIGHT * 0.7219)))
    screen.blit(text_goal, (int(ui_variables.SCREEN_WIDTH * 0.045) + sidebar_width, int(ui_variables.SCREEN_HEIGHT * 0.8395)))
    screen.blit(goal_value, (int(ui_variables.SCREEN_WIDTH * 0.055) + sidebar_width, int(ui_variables.SCREEN_HEIGHT * 0.8823)))
    screen.blit(text_fever, (int(ui_variables.SCREEN_WIDTH * 0.12) + sidebar_width, int(ui_variables.SCREEN_HEIGHT * 0.8395)))
    screen.blit(next_fever_value, (int(ui_variables.SCREEN_WIDTH * 0.13) + sidebar_width, int(ui_variables.SCREEN_HEIGHT * 0.8823)))
...
item_list = [] # 변하면 안 됨
inven = [] # 변함
dx_inven1 = int(ui_variables.SCREEN_WIDTH * 0.5905) # 인벤토리 1 중심의 x좌표
dx_inven2 = int(ui_variables.SCREEN_WIDTH * 0.6499) # 인벤토리 2 중심의 x좌표
